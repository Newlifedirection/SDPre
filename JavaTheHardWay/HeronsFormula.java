public class HeronsFormula {
	...
	//This function computes the area of a triangle with sides lengths a, b, & c.
...
//Writing the code without functions is longer
//Instead of changing the / 2 once, you would have to change it 6 time.
//It was not difficult to add two lines like lines 6 & 7, but change 3s to 9s.
//Would need to add 6 lines of code and be sure the / 2 are changed to / 2.0.